...
internal sealed class GlovesRecipeJsonConverter : JsonConverter<GlovesRecipe>
{
    ...
    public static GlovesRecipe Read(in JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, GlovesRecipe value)
    {
