...
internal sealed class RandomUnlockerJsonConverter : JsonConverter<RandomUnlocker>
{
    public const string DiscriminatorValue = "random_unlocker";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(RandomUnlocker).IsAssignableFrom(typeToConvert);
    }

    public override RandomUnlocker Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, RandomUnlocker value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static RandomUnlocker Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, RandomUnlocker value)
    {
