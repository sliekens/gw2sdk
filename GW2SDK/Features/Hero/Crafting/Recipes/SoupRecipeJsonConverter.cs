...
internal sealed class SoupRecipeJsonConverter : JsonConverter<SoupRecipe>
{
    public const string DiscriminatorValue = "soup_recipe";

    public override SoupRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, SoupRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static SoupRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, SoupRecipe value)
    {
