...
public sealed class QuagganByIdRequest : IHttpRequest<IReplica<Quaggan>>
{
    ...
    public async Task<IReplica<Quaggan>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<Quaggan>(response.Headers.Date.GetValueOrDefault(),
            value,
