...
internal sealed class PotionRecipeJsonConverter : JsonConverter<PotionRecipe>
{
    public const string DiscriminatorValue = "potion_recipe";

    public override PotionRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, PotionRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static PotionRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, PotionRecipe value)
    {
