...
internal sealed class TridentJsonConverter : JsonConverter<Trident>
{
    public const string DiscriminatorValue = "trident";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Trident).IsAssignableFrom(typeToConvert);
    }

    public override Trident Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Trident value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Trident Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Trident value)
    {
