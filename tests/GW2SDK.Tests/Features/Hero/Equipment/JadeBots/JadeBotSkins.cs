...
public class JadeBotSkins
{
    ...
    public async Task Can_be_listed()
    {
        ...
        (HashSet<JadeBotSkin> actual, MessageContext context) = await sut.Hero.Equipment.JadeBots.GetJadeBotSkins(cancellationToken: TestContext.Current!.CancellationToken);
