...
internal sealed class GlovesJsonConverter : JsonConverter<Gloves>
{
    public const string DiscriminatorValue = "gloves";

    public override Gloves Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Gloves value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Gloves Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Gloves value)
    {
