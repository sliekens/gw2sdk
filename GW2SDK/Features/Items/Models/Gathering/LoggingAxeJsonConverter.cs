...
internal sealed class LoggingAxeJsonConverter : JsonConverter<LoggingAxe>
{
    ...
    public override LoggingAxe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, LoggingAxe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
