...
public class EmblemForegroundsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<EmblemForeground> actual, MessageContext context) = await sut.Guilds.GetEmblemForegroundsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
