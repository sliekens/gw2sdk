...
public class GliderSkinsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<GliderSkin> actual, MessageContext context) = await sut.Hero.Equipment.Gliders.GetGliderSkinsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
