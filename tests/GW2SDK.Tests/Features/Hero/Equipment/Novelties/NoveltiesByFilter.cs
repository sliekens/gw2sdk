...
public class NoveltiesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Novelty> actual, MessageContext context) = await sut.Hero.Equipment.Novelties.GetNoveltiesByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
