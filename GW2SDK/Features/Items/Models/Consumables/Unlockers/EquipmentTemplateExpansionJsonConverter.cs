...
internal sealed class
    EquipmentTemplateExpansionJsonConverter : JsonConverter<EquipmentTemplateExpansion>
{
    ...
    public override EquipmentTemplateExpansion Read(
    ...
    public override void Write(
        ...
        EquipmentTemplateExpansion value,
        JsonSerializerOptions options
    )
    {
        Write(writer, value);
    ...
    public static EquipmentTemplateExpansion Read(in JsonElement json)
    {
