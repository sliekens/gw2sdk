...
public class FinishersByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Finisher> actual, MessageContext context) = await sut.Hero.Equipment.Finishers.GetFinishersByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
