...
public class MountSkinsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<MountSkin> actual, MessageContext context) = await sut.Hero.Equipment.Mounts.GetMountSkinsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
