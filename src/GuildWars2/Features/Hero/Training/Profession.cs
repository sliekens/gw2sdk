...
public sealed record Profession
{
    ...
    public static readonly IImmutableValueList<Extensible<ProfessionName>> AllProfessions =
        new ImmutableValueList<Extensible<ProfessionName>>([
            Elementalist,
            Engineer,
            Guardian,
            Mesmer,
    ...
    public required IImmutableValueList<int> SpecializationIds { get; init; }
    ...
    public required IImmutableValueDictionary<Extensible<WeaponType>, WeaponProficiency> Weapons { get; init; }
    ...
    public required IImmutableValueList<Training> Training { get; init; }
    ...
    public required IImmutableValueDictionary<int, int> SkillsByPalette { get; init; }
}
