...
[ServiceDataSource]
public class GuildMembers(Gw2Client sut)
{
    [Test]
    public async Task Can_be_found()
    {
        ...
        {
            (IImmutableValueList<GuildMember> actual, _) = await sut.Guilds.GetGuildMembers(guildId, guildLeader.Token, cancellationToken: TestContext.Current!.Execution.CancellationToken);
