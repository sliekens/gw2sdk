...
internal sealed class HelmJsonConverter : JsonConverter<Helm>
{
    public const string DiscriminatorValue = "helm";

    public override Helm Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Helm value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Helm Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Helm value)
    {
