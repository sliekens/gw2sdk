...
internal sealed class HalloweenConsumableJsonConverter : JsonConverter<HalloweenConsumable>
{
    public const string DiscriminatorValue = "halloween_consumable";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(HalloweenConsumable).IsAssignableFrom(typeToConvert);
    }

    public override HalloweenConsumable Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, HalloweenConsumable value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static HalloweenConsumable Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, HalloweenConsumable value)
    {
