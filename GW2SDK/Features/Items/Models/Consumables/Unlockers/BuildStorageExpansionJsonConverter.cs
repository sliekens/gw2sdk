...
internal sealed class BuildStorageExpansionJsonConverter : JsonConverter<BuildStorageExpansion>
{
    public const string DiscriminatorValue = "build_storage_expansion";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(BuildStorageExpansion).IsAssignableFrom(typeToConvert);
    }

    public override BuildStorageExpansion Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, BuildStorageExpansion value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static BuildStorageExpansion Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, BuildStorageExpansion value)
    {
