...
public sealed class SkinsByPageRequest : IHttpRequest<IReplicaPage<Skin>>
{
    ...
    public async Task<IReplicaPage<Skin>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<Skin>(response.Headers.Date.GetValueOrDefault(),
            value,
