...
internal sealed class FashionTemplateExpansionJsonConverter : JsonConverter<FashionTemplateExpansion>
{
    public const string DiscriminatorValue = "fashion_template_expansion";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(FashionTemplateExpansion).IsAssignableFrom(typeToConvert);
    }

    public override FashionTemplateExpansion Read(
    ...
    public override void Write(
        ...
        FashionTemplateExpansion value,
        JsonSerializerOptions options
    )
    {
        Write(writer, value);
    ...
    public static FashionTemplateExpansion Read(in JsonElement json)
    {
        ...
        return new FashionTemplateExpansion
        {
    ...
    public static void Write(Utf8JsonWriter writer, FashionTemplateExpansion value)
    {
