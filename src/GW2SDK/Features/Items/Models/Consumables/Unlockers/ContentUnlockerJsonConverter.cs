...
internal sealed class ContentUnlockerJsonConverter : JsonConverter<ContentUnlocker>
{
    public const string DiscriminatorValue = "content_unlocker";
    ...
    public static ContentUnlocker Read(in JsonElement json)
    {
