...
public sealed class TitleByIdRequest : IHttpRequest<IReplica<Title>>
{
    ...
    public async Task<IReplica<Title>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<Title>(response.Headers.Date.GetValueOrDefault(),
            value,
