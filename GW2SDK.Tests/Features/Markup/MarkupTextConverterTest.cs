...
public class MarkupTextConverterTest
{
    ...
    public void Describe_End_of_Dragons_Launch_Supply_Drop_Requisition()
    {
        var input = "Use this to sign your account up for weekly End of Dragons Launch Supply "
            ...
            + "Second Drop:<br>A Black Lion Backpack and Glider Combo Voucher, an End of "
            + "Dragons Expedition Board, and 2 Heroic Boosters.<br>Third Drop:<br>A Black "
            + "Lion Outfit Voucher, a Black Lion Weapon Voucher, 2 Fine Black Lion Dye "
            + "Canisters—Blue, 2 Fine Black Lion Dye Canisters—Green, 2 Fine Black Lion "
