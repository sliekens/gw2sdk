...
public sealed class TraitByIdRequest : IHttpRequest<IReplica<Trait>>
{
    ...
    public async Task<IReplica<Trait>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<Trait>(response.Headers.Date.GetValueOrDefault(),
            value,
