...
public class FinishersIndex(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<int> actual, MessageContext context) = await sut.Hero.Equipment.Finishers.GetFinishersIndex(TestContext.Current!.Execution.CancellationToken);
