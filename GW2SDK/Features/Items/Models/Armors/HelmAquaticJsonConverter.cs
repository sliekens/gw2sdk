...
internal sealed class HelmAquaticJsonConverter : JsonConverter<HelmAquatic>
{
    public const string DiscriminatorValue = "helm_aquatic";

    public override HelmAquatic Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, HelmAquatic value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static HelmAquatic Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, HelmAquatic value)
    {
