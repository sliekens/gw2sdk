...
internal sealed class BuildTemplateExpansionJsonConverter : JsonConverter<BuildTemplateExpansion>
{
    public const string DiscriminatorValue = "build_template_expansion";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(BuildTemplateExpansion).IsAssignableFrom(typeToConvert);
    }

    public override BuildTemplateExpansion Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, BuildTemplateExpansion value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static BuildTemplateExpansion Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, BuildTemplateExpansion value)
    {
