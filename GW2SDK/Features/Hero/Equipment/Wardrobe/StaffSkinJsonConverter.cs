...
internal sealed class StaffSkinJsonConverter : JsonConverter<StaffSkin>
{
    public const string DiscriminatorValue = "staff_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(StaffSkin).IsAssignableFrom(typeToConvert);
    }

    public override StaffSkin Read(
    ...
    public static StaffSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, StaffSkin value)
    {
