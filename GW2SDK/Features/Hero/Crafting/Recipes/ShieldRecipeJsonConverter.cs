...
internal sealed class ShieldRecipeJsonConverter : JsonConverter<ShieldRecipe>
{
    public const string DiscriminatorValue = "shield_recipe";

    public override ShieldRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, ShieldRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static ShieldRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, ShieldRecipe value)
    {
