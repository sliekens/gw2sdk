...
namespace GW2SDK.Tests.Features.Items
{
    ...
    public class GizmoDiscriminatorOptionsTest
    {
        public GizmoDiscriminatorOptionsTest(ItemFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public void It_supports_every_known_type_name()
        {
            ...
            var expected = _fixture.Db.GetGizmoTypeNames().ToHashSet();
