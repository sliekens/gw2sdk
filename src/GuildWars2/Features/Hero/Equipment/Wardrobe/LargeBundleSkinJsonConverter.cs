...
internal sealed class LargeBundleSkinJsonConverter : JsonConverter<LargeBundleSkin>
{
    public const string DiscriminatorValue = "large_bundle_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(LargeBundleSkin).IsAssignableFrom(typeToConvert);
    }

    public override LargeBundleSkin Read(
    ...
    public static LargeBundleSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, LargeBundleSkin value)
    {
