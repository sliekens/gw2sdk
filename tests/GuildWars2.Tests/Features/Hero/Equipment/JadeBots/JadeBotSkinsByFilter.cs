...
public class JadeBotSkinsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<JadeBotSkin> actual, MessageContext context) = await sut.Hero.Equipment.JadeBots.GetJadeBotSkinsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
