...
namespace GW2SDK.Json
{
    ...
    public enum MissingMemberBehavior
    {
        ...
        /// <remarks>Use this when correctness of the data is more important than availability. Errors may be thrown when new data is added to the game. GW2SDK must be updated to use the new data.</remarks>
        Error,
        ...
        /// <remarks>Use this when availability of the data is more important than correctness. Object details may be lost when new data is added to the game. GW2SDK must be updated to get the full representation.</remarks>
        Undefined
    }
}
