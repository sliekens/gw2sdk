...
internal sealed class GreatswordSkinJsonConverter : JsonConverter<GreatswordSkin>
{
    public const string DiscriminatorValue = "greatsword_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(GreatswordSkin).IsAssignableFrom(typeToConvert);
    }

    public override GreatswordSkin Read(
    ...
    public static GreatswordSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, GreatswordSkin value)
    {
