...
public class ColorsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<DyeColor> actual, MessageContext context) = await sut.Hero.Equipment.Dyes.GetColorsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
        ...
        foreach (DyeColor entry in actual)
        {
