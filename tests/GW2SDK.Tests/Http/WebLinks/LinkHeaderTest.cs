...
public class LinkHeaderTest
{
    ...
    public void It_can_parse_link_headers()
    {
        ...
        Assert.Collection(actual.Links, rel => IsLink(rel, "previous", "/v2/colors?page=117&page_size=5"), rel => IsLink(rel, "next", "/v2/colors?page=119&page_size=5"), rel => IsLink(rel, "self", "/v2/colors?page=118&page_size=5"), rel => IsLink(rel, "first", "/v2/colors?page=0&page_size=5"), rel => IsLink(rel, "last", "/v2/colors?page=119&page_size=5"));
