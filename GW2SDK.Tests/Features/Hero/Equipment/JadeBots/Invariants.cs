...
internal static class Invariants
{
    ...
    internal static void Has_description(this JadeBot actual) => Assert.NotEmpty(actual.Description);

    internal static void Has_unlock_item(this JadeBot actual) => Assert.True(actual.UnlockItemId > 0);
}
