...
public class AchievementGroupsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<AchievementGroup> actual, MessageContext context) = await sut.Hero.Achievements.GetAchievementGroupsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
