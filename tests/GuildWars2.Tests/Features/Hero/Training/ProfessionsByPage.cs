...
public class ProfessionsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<Profession> actual, MessageContext context) = await sut.Hero.Training.GetProfessionsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
        ...
        foreach (Profession entry in actual)
        {
