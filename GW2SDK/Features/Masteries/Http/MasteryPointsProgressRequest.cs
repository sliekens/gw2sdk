...
[PublicAPI]
public sealed class MasteryPointsProgressRequest : IHttpRequest<Replica<MasteryPointsProgress>>
{
    ...
    )
    {
        ...
        {
            Value = json.RootElement.GetMasteryPointsProgress(MissingMemberBehavior),
