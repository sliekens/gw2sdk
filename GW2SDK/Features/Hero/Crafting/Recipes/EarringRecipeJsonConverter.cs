...
internal sealed class EarringRecipeJsonConverter : JsonConverter<EarringRecipe>
{
    public const string DiscriminatorValue = "earring_recipe";

    public override EarringRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, EarringRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static EarringRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, EarringRecipe value)
    {
