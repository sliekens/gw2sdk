...
public class StorylinesIndex(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<string> actual, MessageContext context) = await sut.Hero.StoryJournal.GetStorylinesIndex(TestContext.Current!.Execution.CancellationToken);
