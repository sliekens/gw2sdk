...
public class SpecializationsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Specialization> actual, MessageContext context) = await sut.Hero.Builds.GetSpecializationsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
