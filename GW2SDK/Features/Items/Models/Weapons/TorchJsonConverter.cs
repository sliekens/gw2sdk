...
internal sealed class TorchJsonConverter : JsonConverter<Torch>
{
    public const string DiscriminatorValue = "torch";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Torch).IsAssignableFrom(typeToConvert);
    }

    public override Torch Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Torch value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Torch Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Torch value)
    {
