...
internal sealed class
    MistChampionSkinUnlockerJsonConverter : JsonConverter<MistChampionSkinUnlocker>
{
    ...
    public override MistChampionSkinUnlocker Read(
    ...
    public override void Write(
        ...
        MistChampionSkinUnlocker value,
        JsonSerializerOptions options
    )
    {
        Write(writer, value);
    ...
    public static MistChampionSkinUnlocker Read(in JsonElement json)
    {
