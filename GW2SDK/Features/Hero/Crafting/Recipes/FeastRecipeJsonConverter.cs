...
internal sealed class FeastRecipeJsonConverter : JsonConverter<FeastRecipe>
{
    public const string DiscriminatorValue = "feast_recipe";

    public override FeastRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, FeastRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static FeastRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, FeastRecipe value)
    {
