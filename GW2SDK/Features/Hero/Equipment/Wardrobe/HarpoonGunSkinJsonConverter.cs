...
internal sealed class HarpoonGunSkinJsonConverter : JsonConverter<HarpoonGunSkin>
{
    public const string DiscriminatorValue = "harpoon_gun_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(HarpoonGunSkin).IsAssignableFrom(typeToConvert);
    }

    public override HarpoonGunSkin Read(
    ...
    public static HarpoonGunSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, HarpoonGunSkin value)
    {
