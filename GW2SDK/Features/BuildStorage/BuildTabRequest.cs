...
[PublicAPI]
public sealed class BuildTabRequest : IHttpRequest<Replica<BuildTab>>
{
    private static readonly HttpRequestMessageTemplate Template = new(Get, "v2/characters/:id/buildtabs/:tab")
    {
        AcceptEncoding = "gzip"
    };
