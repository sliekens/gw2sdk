...
internal sealed class DaggerRecipeJsonConverter : JsonConverter<DaggerRecipe>
{
    public const string DiscriminatorValue = "dagger_recipe";

    public override DaggerRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, DaggerRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static DaggerRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, DaggerRecipe value)
    {
