...
internal sealed class HammerRecipeJsonConverter : JsonConverter<HammerRecipe>
{
	public const string DiscriminatorValue = "hammer_recipe";

	public override HammerRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
		using var json = JsonDocument.ParseValue(ref reader);
		return Read(json.RootElement);
	}

	public override void Write(Utf8JsonWriter writer, HammerRecipe value, JsonSerializerOptions options)
	{
		Write(writer, value);
	}

	public static HammerRecipe Read(JsonElement json)
	{
	...
	public static void Write(Utf8JsonWriter writer, HammerRecipe value)
	{
