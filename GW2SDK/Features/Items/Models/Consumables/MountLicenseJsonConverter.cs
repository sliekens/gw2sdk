...
internal sealed class MountLicenseJsonConverter : JsonConverter<MountLicense>
{
    public const string DiscriminatorValue = "mount_license";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(MountLicense).IsAssignableFrom(typeToConvert);
    }

    public override MountLicense Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, MountLicense value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static MountLicense Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, MountLicense value)
    {
