...
public class ItemPricesByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<ItemPrice> actual, MessageContext context) = await sut.Commerce.GetItemPricesByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
