...
internal static class GlovesSkinJson
{
    public static GlovesSkin GetGlovesSkin(this in JsonElement json)
    {
        ...
        return new GlovesSkin
        {
            ...
            DyeSlots = dyeSlots.Map(static (in value) => value.GetDyeSlotInfo())
        };
    }
}
