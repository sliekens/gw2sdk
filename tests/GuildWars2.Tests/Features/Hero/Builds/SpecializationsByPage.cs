...
public class SpecializationsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<Specialization> actual, MessageContext context) = await sut.Hero.Builds.GetSpecializationsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
