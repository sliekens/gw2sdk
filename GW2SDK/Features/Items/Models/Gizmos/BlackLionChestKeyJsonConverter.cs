...
internal sealed class BlackLionChestKeyJsonConverter : JsonConverter<BlackLionChestKey>
{
    ...
    public override BlackLionChestKey? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, BlackLionChestKey value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
