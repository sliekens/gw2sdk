...
internal sealed class WarhornJsonConverter : JsonConverter<Warhorn>
{
    public const string DiscriminatorValue = "warhorn";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Warhorn).IsAssignableFrom(typeToConvert);
    }

    public override Warhorn Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Warhorn value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Warhorn Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Warhorn value)
    {
