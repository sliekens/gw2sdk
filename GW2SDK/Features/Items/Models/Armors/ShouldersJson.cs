...
internal static class ShouldersJson
{
    public static Shoulders GetShoulders(this in JsonElement json)
    {
...
#pragma warning restore CS0618
            ...
            Attributes = infixUpgradeAttributes.Map(static (in JsonElement values) => values.GetAttributes()) ?? new Collections.ValueDictionary<Extensible<AttributeName>, int>(),
