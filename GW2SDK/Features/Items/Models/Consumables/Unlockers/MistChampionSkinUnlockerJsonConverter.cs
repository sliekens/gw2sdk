...
internal sealed class MistChampionSkinUnlockerJsonConverter : JsonConverter<MistChampionSkinUnlocker>
{
    public const string DiscriminatorValue = "mist_champion_skin_unlocker";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(MistChampionSkinUnlocker).IsAssignableFrom(typeToConvert);
    }

    public override MistChampionSkinUnlocker Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, MistChampionSkinUnlocker value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static MistChampionSkinUnlocker Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, MistChampionSkinUnlocker value)
    {
