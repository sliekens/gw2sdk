...
public class AchievementsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Achievement> actual, MessageContext context) = await sut.Hero.Achievements.GetAchievementsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
