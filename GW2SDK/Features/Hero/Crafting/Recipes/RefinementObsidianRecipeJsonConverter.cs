...
internal sealed class
    RefinementObsidianRecipeJsonConverter : JsonConverter<RefinementObsidianRecipe>
{
    public const string DiscriminatorValue = "refinement_obsidian_recipe";

    public override RefinementObsidianRecipe Read(
    ...
    public override void Write(
        ...
        RefinementObsidianRecipe value,
        JsonSerializerOptions options
    )
    {
        Write(writer, value);
    ...
    public static RefinementObsidianRecipe Read(in JsonElement json)
    {
