...
internal sealed class SpearSkinJsonConverter : JsonConverter<SpearSkin>
{
    public const string DiscriminatorValue = "spear_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(SpearSkin).IsAssignableFrom(typeToConvert);
    }

    public override SpearSkin Read(
    ...
    public static SpearSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, SpearSkin value)
    {
