...
public sealed class OrderBookByIdRequest : IHttpRequest<IReplica<OrderBook>>
{
    ...
    public async Task<IReplica<OrderBook>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<OrderBook>(response.Headers.Date.GetValueOrDefault(),
            value,
