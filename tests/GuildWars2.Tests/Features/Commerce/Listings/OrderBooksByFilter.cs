...
public class OrderBooksByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<OrderBook> actual, MessageContext context) = await sut.Commerce.GetOrderBooksByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
