...
internal sealed class HammerJsonConverter : JsonConverter<Hammer>
{
    public const string DiscriminatorValue = "hammer";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Hammer).IsAssignableFrom(typeToConvert);
    }
    ...
    public override void Write(Utf8JsonWriter writer, Hammer value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Hammer Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Hammer value)
    {
