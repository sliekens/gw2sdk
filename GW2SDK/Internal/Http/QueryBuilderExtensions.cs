...
internal static class QueryBuilderExtensions
{
    ...
    internal static void AddId(this QueryBuilder query, string id)
    {
        query.Add("id", id);
    }

    internal static void AddId(this QueryBuilder query, int id)
    {
        query.Add("id", id);
    }
    ...
    internal static void AddAllIds(this QueryBuilder query)
    {
        query.Add("ids", "all");
    }
