...
public class GliderSkinsIndex(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<int> actual, MessageContext context) = await sut.Hero.Equipment.Gliders.GetGliderSkinsIndex(TestContext.Current!.Execution.CancellationToken);
