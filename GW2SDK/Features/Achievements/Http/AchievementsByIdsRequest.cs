...
public sealed class AchievementsByIdsRequest : IHttpRequest<IReplicaSet<Achievement>>
{
    ...
    public async Task<IReplicaSet<Achievement>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaSet<Achievement>(response.Headers.Date.GetValueOrDefault(),
            value,
