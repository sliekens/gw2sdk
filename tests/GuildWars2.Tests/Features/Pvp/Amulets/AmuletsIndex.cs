...
[ServiceDataSource]
public class AmuletsIndex(Gw2Client sut)
{
    [Test]
    public async Task Can_be_listed()
    {
        (IImmutableValueSet<int> actual, MessageContext context) = await sut.Pvp.GetAmuletsIndex(TestContext.Current!.Execution.CancellationToken);
