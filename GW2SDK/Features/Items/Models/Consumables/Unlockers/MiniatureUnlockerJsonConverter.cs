...
internal sealed class MiniatureUnlockerJsonConverter : JsonConverter<MiniatureUnlocker>
{
    ...
    public override MiniatureUnlocker Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, MiniatureUnlocker value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
