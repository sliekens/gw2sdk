...
internal sealed class CompletedPathsRequest : IHttpRequest<Replica<HashSet<string>>>
{
    private static readonly HttpRequestMessageTemplate Template = new(Get, "v2/account/dungeons")
    {
        AcceptEncoding = "gzip",
