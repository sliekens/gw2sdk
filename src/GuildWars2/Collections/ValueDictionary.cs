...
{
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that is empty.</summary>
    public ValueDictionary()
    {
    }

    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that is empty and uses the specified comparer.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that is empty and has the specified initial capacity.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that is empty, has the specified initial capacity, and uses the specified comparer.</summary>
    /// <param name="capacity">The number of elements that the new dictionary can initially store.</param>
    /// <param name="comparer">The comparer to use for the keys.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that contains elements copied from the specified dictionary.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that contains elements copied from the specified dictionary and uses the specified comparer.</summary>
    /// <param name="dictionary">The dictionary whose elements are copied to the new dictionary.</param>
    /// <param name="comparer">The comparer to use for the keys.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that contains elements copied from the specified collection.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ValueDictionary{TKey, TValue}"/> class that contains elements copied from the specified collection and uses the specified comparer.</summary>
    /// <param name="collection">The collection whose elements are copied to the new dictionary.</param>
    /// <param name="comparer">The comparer to use for the keys.</param>
    public ValueDictionary(
    ...
    /// <summary>Determines whether the current <see cref="ValueDictionary{TKey, TValue}"/> is equal to another <see cref="ValueDictionary{TKey, TValue}"/> based on value semantics.</summary>
    ...
    /// <summary>Determines whether two <see cref="ValueDictionary{TKey, TValue}"/> instances are equal by value.</summary>
    ...
    /// <summary>Determines whether two <see cref="ValueDictionary{TKey, TValue}"/> instances are not equal by value.</summary>
    /// <param name="left">The first <see cref="ValueDictionary{TKey, TValue}"/> to compare.</param>
    /// <param name="right">The second <see cref="ValueDictionary{TKey, TValue}"/> to compare.</param>
    public static bool operator !=(
        ValueDictionary<TKey, TValue>? left,
