...
public class GuildTreasury(Gw2Client sut)
{
    ...
    public async Task Can_be_found()
    {
        ...
        {
            (IImmutableValueList<GuildTreasurySlot> actual, _) = await sut.Guilds.GetGuildTreasury(guildId, guildLeader.Token, cancellationToken: TestContext.Current!.Execution.CancellationToken);
