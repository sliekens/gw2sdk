...
public class FinishersByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Finisher> actual, MessageContext context) = await sut.Hero.Equipment.Finishers.GetFinishersByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
