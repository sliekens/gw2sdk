...
internal static class FashionTemplateExpansionJson
{
    public static FashionTemplateExpansion GetFashionTemplateExpansion(this in JsonElement json)
    {
        ...
        foreach (JsonProperty member in json.EnumerateObject())
        {
            ...
            else if (member.NameEquals("details"))
            {
                foreach (JsonProperty detail in member.Value.EnumerateObject())
                {
                    ...
                    {
                        if (!detail.Value.ValueEquals("WardrobeTemplateTab"))
                        {
                            ThrowHelper.ThrowInvalidDiscriminator(detail.Value.GetString());
                        }
                    }
