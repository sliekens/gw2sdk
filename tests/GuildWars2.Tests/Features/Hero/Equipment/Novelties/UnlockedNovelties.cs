...
public class UnlockedNovelties(Gw2Client sut)
{
    ...
    public async Task Can_be_listed()
    {
        ...
        (IImmutableValueSet<int> actual, _) = await sut.Hero.Equipment.Novelties.GetUnlockedNovelties(accessToken.Key, TestContext.Current!.Execution.CancellationToken);
