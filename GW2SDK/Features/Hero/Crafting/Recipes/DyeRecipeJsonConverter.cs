...
internal sealed class DyeRecipeJsonConverter : JsonConverter<DyeRecipe>
{
    public const string DiscriminatorValue = "dye_recipe";

    public override DyeRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, DyeRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static DyeRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, DyeRecipe value)
    {
