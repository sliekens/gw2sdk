...
public sealed class ItemStatsByPageRequest : IHttpRequest<IReplicaPage<ItemStat>>
{
    ...
    public async Task<IReplicaPage<ItemStat>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<ItemStat>(response.Headers.Date.GetValueOrDefault(),
            value,
