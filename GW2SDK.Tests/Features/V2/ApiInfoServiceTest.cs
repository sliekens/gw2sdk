...
public class ApiInfoServiceTest
{
    ...
    {
        public static void There_are_no_newer_translations(ApiInfo actual)
        {
    ...
    public async Task It_can_get_the_current_api_info()
    {
        ...
        ApiInfoFact.There_are_no_newer_translations(actual.Value);
        ApiInfoFact.There_are_no_surprise_endpoints(actual.Value);
        ApiInfoFact.There_are_no_newer_schema_versions(actual.Value);
    }
}