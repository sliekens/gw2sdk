...
public sealed class SkillsByPageRequest : IHttpRequest<IReplicaPage<Skill>>
{
    ...
    public SkillsByPageRequest(int pageIndex)
    {
        PageIndex = pageIndex;
    }
    ...
    public async Task<IReplicaPage<Skill>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<Skill>(response.Headers.Date.GetValueOrDefault(),
            value,
