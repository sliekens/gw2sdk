...
/// <summary>JSON converter factory for <see cref="IImmutableValueSet{T}"/>.</summary>
public sealed class ImmutableValueSetJsonConverterFactory : JsonConverterFactory
{
    /// <inheritdoc />
    public override bool CanConvert(Type typeToConvert)
    {
        ...
        return genericTypeDefinition == typeof(IImmutableValueSet<>);
    }
