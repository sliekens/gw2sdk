...
public sealed class MailCarriersByPageRequest : IHttpRequest<IReplicaPage<MailCarrier>>
{
    ...
    public async Task<IReplicaPage<MailCarrier>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<MailCarrier>(response.Headers.Date.GetValueOrDefault(),
            value,
