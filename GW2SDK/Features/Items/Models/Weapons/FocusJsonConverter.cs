...
internal sealed class FocusJsonConverter : JsonConverter<Focus>
{
    public const string DiscriminatorValue = "focus";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Focus).IsAssignableFrom(typeToConvert);
    }

    public override Focus Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public static Focus Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Focus value)
    {
