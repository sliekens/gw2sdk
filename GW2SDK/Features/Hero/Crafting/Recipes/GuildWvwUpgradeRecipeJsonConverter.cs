...
internal sealed class GuildWvwUpgradeRecipeJsonConverter : JsonConverter<GuildWvwUpgradeRecipe>
{
    ...
    public static GuildWvwUpgradeRecipe Read(in JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, GuildWvwUpgradeRecipe value)
    {
        ...
        if (value.OutputUpgradeId.HasValue)
        {
            writer.WriteNumber("output_upgrade_id", value.OutputUpgradeId.Value);
        }
        else
        {
            writer.WriteNull("output_upgrade_id");
        }
