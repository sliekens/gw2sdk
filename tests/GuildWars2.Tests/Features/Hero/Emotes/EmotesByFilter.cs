...
public class EmotesByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Emote> actual, MessageContext context) = await sut.Hero.Emotes.GetEmotesByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
