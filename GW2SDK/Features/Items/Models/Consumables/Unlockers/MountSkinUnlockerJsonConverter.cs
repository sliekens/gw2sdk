...
internal sealed class MountSkinUnlockerJsonConverter : JsonConverter<MountSkinUnlocker>
{
    ...
    public override MountSkinUnlocker Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, MountSkinUnlocker value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
