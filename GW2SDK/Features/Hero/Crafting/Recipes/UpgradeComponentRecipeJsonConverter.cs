...
internal sealed class UpgradeComponentRecipeJsonConverter : JsonConverter<UpgradeComponentRecipe>
{
    public const string DiscriminatorValue = "upgrade_component_recipe";

    public override UpgradeComponentRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, UpgradeComponentRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static UpgradeComponentRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, UpgradeComponentRecipe value)
    {
