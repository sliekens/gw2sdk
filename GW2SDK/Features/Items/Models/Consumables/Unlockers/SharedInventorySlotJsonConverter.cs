...
internal sealed class SharedInventorySlotJsonConverter : JsonConverter<SharedInventorySlot>
{
    ...
    public override SharedInventorySlot Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, SharedInventorySlot value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
