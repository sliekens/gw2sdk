...
internal sealed class SpearRecipeJsonConverter : JsonConverter<SpearRecipe>
{
    public const string DiscriminatorValue = "spear_recipe";

    public override SpearRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, SpearRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static SpearRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, SpearRecipe value)
    {
