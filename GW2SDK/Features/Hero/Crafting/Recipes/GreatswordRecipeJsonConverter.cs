...
internal sealed class GreatswordRecipeJsonConverter : JsonConverter<GreatswordRecipe>
{
    public const string DiscriminatorValue = "greatsword_recipe";

    public override GreatswordRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, GreatswordRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static GreatswordRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, GreatswordRecipe value)
    {
