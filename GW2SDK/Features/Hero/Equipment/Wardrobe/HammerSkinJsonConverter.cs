...
internal sealed class HammerSkinJsonConverter : JsonConverter<HammerSkin>
{
    public const string DiscriminatorValue = "hammer_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(HammerSkin).IsAssignableFrom(typeToConvert);
    }

    public override HammerSkin Read(
    ...
    public static HammerSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, HammerSkin value)
    {
