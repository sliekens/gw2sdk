...
internal sealed class AxeSkinJsonConverter : JsonConverter<AxeSkin>
{
    public const string DiscriminatorValue = "axe_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(AxeSkin).IsAssignableFrom(typeToConvert);
    }

    public override AxeSkin Read(
    ...
    public override void Write(Utf8JsonWriter writer, AxeSkin value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static AxeSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, AxeSkin value)
    {
