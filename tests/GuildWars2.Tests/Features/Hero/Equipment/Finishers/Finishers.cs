...
public class Finishers(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<Finisher> actual, MessageContext context) = await sut.Hero.Equipment.Finishers.GetFinishers(cancellationToken: TestContext.Current!.Execution.CancellationToken);
