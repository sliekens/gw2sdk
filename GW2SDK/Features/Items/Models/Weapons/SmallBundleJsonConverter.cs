...
internal sealed class SmallBundleJsonConverter : JsonConverter<SmallBundle>
{
    public const string DiscriminatorValue = "small_bundle";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(SmallBundle).IsAssignableFrom(typeToConvert);
    }

    public override SmallBundle Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, SmallBundle value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static SmallBundle Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, SmallBundle value)
    {
