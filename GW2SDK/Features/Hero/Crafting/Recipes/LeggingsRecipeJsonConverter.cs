...
internal sealed class LeggingsRecipeJsonConverter : JsonConverter<LeggingsRecipe>
{
    public const string DiscriminatorValue = "leggings_recipe";

    public override LeggingsRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, LeggingsRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
    ...
    public static void Write(Utf8JsonWriter writer, LeggingsRecipe value)
    {
