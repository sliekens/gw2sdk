...
[PublicAPI]
public sealed class ChartsByPageRequest : IHttpRequest<IReplicaPage<Chart>>
{
    ...
    public ChartsByPageRequest(int continentId, int floorId, int regionId, int pageIndex)
    {
    ...
    public async Task<IReplicaPage<Chart>> SendAsync(
