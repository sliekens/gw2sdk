...
public class Progression
{
    ...
    public async Task Can_be_listed()
    {
        ...
        Assert.Contains(actual, progression => progression is { Id: ProgressionKind.FractalMistAttunement, Value: > 0 });

        Assert.Contains(actual, progression => progression is { Id: ProgressionKind.Luck, Value: > 100 });
    }
}
