...
public class FinishersByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<Finisher> actual, MessageContext context) = await sut.Hero.Equipment.Finishers.GetFinishersByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
