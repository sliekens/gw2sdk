...
[PublicAPI]
public sealed class WorldsByPageRequest : IHttpRequest<IReplicaPage<World>>
{
    ...
    public async Task<IReplicaPage<World>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<World>(response.Headers.Date.GetValueOrDefault(),
            value,
