...
public class GamesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        Assert.Collection(ids, first => Assert.Contains(actual, found => found.Id == first), second => Assert.Contains(actual, found => found.Id == second), third => Assert.Contains(actual, found => found.Id == third), fourth => Assert.Contains(actual, found => found.Id == fourth), fifth => Assert.Contains(actual, found => found.Id == fifth), sixth => Assert.Contains(actual, found => found.Id == sixth), seventh => Assert.Contains(actual, found => found.Id == seventh), eighth => Assert.Contains(actual, found => found.Id == eighth), nineth => Assert.Contains(actual, found => found.Id == nineth), tenth => Assert.Contains(actual, found => found.Id == tenth));
    }
}
