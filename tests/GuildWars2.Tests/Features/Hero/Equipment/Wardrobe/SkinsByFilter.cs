...
public class SkinsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<EquipmentSkin> actual, MessageContext context) = await sut.Hero.Equipment.Wardrobe.GetSkinsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
