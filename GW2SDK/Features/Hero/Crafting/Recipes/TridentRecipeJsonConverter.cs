...
internal sealed class TridentRecipeJsonConverter : JsonConverter<TridentRecipe>
{
    public const string DiscriminatorValue = "trident_recipe";

    public override TridentRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, TridentRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
    ...
    public static void Write(Utf8JsonWriter writer, TridentRecipe value)
    {
