...
internal sealed class ComponentRecipeJsonConverter : JsonConverter<ComponentRecipe>
{
    public const string DiscriminatorValue = "component_recipe";

    public override ComponentRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, ComponentRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static ComponentRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, ComponentRecipe value)
    {
