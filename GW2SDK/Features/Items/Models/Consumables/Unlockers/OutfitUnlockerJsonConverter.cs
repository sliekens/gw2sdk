...
internal sealed class OutfitUnlockerJsonConverter : JsonConverter<OutfitUnlocker>
{
    public const string DiscriminatorValue = "outfit_unlocker";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(OutfitUnlocker).IsAssignableFrom(typeToConvert);
    }

    public override OutfitUnlocker Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, OutfitUnlocker value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static OutfitUnlocker Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, OutfitUnlocker value)
    {
