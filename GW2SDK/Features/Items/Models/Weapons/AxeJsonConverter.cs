...
internal sealed class AxeJsonConverter : JsonConverter<Axe>
{
    public const string DiscriminatorValue = "axe";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Axe).IsAssignableFrom(typeToConvert);
    }

    public override Axe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Axe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Axe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Axe value)
    {
