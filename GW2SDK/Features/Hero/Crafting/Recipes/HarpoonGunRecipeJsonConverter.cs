...
internal sealed class HarpoonGunRecipeJsonConverter : JsonConverter<HarpoonGunRecipe>
{
    public const string DiscriminatorValue = "harpoon_gun_recipe";

    public override HarpoonGunRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, HarpoonGunRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static HarpoonGunRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, HarpoonGunRecipe value)
    {
