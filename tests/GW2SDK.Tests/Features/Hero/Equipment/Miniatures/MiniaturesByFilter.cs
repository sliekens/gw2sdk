...
public class MiniaturesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Miniature> actual, MessageContext context) = await sut.Hero.Equipment.Miniatures.GetMiniaturesByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
