...
{
    internal static void There_are_no_newer_translations(this ApiVersion actual) =>
        Assert.All(
            actual.Languages,
            language =>
            {
    ...
    internal static void There_are_no_newer_schema_versions(this ApiVersion actual) =>
        Assert.Collection(
    ...
    internal static void There_are_no_surprise_endpoints(this ApiVersion actual)
    {
