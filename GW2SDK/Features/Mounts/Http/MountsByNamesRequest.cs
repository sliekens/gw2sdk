...
public sealed class MountsByNamesRequest : IHttpRequest<IReplicaSet<Mount>>
{
    ...
    public async Task<IReplicaSet<Mount>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaSet<Mount>(response.Headers.Date.GetValueOrDefault(),
            value,
