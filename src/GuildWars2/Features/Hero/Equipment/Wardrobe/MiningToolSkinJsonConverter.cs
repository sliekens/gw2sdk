...
internal sealed class MiningToolSkinJsonConverter : JsonConverter<MiningToolSkin>
{
    public const string DiscriminatorValue = "mining_tool_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(MiningToolSkin).IsAssignableFrom(typeToConvert);
    }

    public override MiningToolSkin Read(
    ...
    public static MiningToolSkin Read(in JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, MiningToolSkin value)
    {
