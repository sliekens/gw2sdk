...
internal sealed class SnackRecipeJsonConverter : JsonConverter<SnackRecipe>
{
    public const string DiscriminatorValue = "snack_recipe";

    public override SnackRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, SnackRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static SnackRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, SnackRecipe value)
    {
