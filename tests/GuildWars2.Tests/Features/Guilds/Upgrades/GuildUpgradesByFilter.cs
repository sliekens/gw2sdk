...
public class GuildUpgradesByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<GuildUpgrade> actual, MessageContext context) = await sut.Guilds.GetGuildUpgradesByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
