...
[PublicAPI]
public static class GuildConsumableWvwRecipeJson
{
    public static GuildConsumableWvwRecipe GetGuildConsumableWvwRecipe(
    ...
    )
    {
        ...
        NullableMember outputUpgradeId = new("output_upgrade_id");
