...
internal sealed class StaffJsonConverter : JsonConverter<Staff>
{
    public const string DiscriminatorValue = "staff";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Staff).IsAssignableFrom(typeToConvert);
    }

    public override Staff Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Staff value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Staff Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Staff value)
    {
