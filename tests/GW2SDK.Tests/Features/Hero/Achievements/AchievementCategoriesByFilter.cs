...
public class AchievementCategoriesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<AchievementCategory> actual, MessageContext context) = await sut.Hero.Achievements.GetAchievementCategoriesByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
