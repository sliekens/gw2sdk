...
public class AstralRewardsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<AstralReward> actual, MessageContext context) = await sut.WizardsVault.GetAstralRewardsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
