...
internal sealed class SwordJsonConverter : JsonConverter<Sword>
{
    public const string DiscriminatorValue = "sword";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Sword).IsAssignableFrom(typeToConvert);
    }

    public override Sword Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Sword value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Sword Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Sword value)
    {
