...
internal sealed class ScepterSkinJsonConverter : JsonConverter<ScepterSkin>
{
    public const string DiscriminatorValue = "scepter_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(ScepterSkin).IsAssignableFrom(typeToConvert);
    }

    public override ScepterSkin Read(
    ...
    public static ScepterSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, ScepterSkin value)
    {
