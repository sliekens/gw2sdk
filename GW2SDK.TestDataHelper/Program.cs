...
public class Program
{
    public static async Task Main(string outDir)
    {
        ...
        {
            Console.WriteLine("Downloading achievements.");
        ...
        {
            Console.WriteLine("Downloading recipes.");
        ...
        {
            Console.WriteLine("Downloading skins.");
        ...
        {
            Console.WriteLine("Downloading floors 1/2.");
        ...
        {
            Console.WriteLine("Downloading floors 2/2.");
            var service = services.Resolve<JsonFloorService>();
        ...
        {
            Console.WriteLine("Downloading item prices.");
        ...
        {
            Console.WriteLine("Downloading item listings.");
