...
internal sealed class WarhornRecipeJsonConverter : JsonConverter<WarhornRecipe>
{
    ...
    public override WarhornRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, WarhornRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
