...
public class ColorsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<DyeColor> actual, MessageContext context) = await sut.Hero.Equipment.Dyes.GetColorsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
