...
public class AttributeCombinationsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<AttributeCombination> actual, MessageContext context) = await sut.Items.GetAttributeCombinationsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
