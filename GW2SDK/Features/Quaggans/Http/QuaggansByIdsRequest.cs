...
public sealed class QuaggansByIdsRequest : IHttpRequest<IReplicaSet<Quaggan>>
{
    ...
    public async Task<IReplicaSet<Quaggan>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaSet<Quaggan>(response.Headers.Date.GetValueOrDefault(),
            value,
