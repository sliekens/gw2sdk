...
internal sealed class RingRecipeJsonConverter : JsonConverter<RingRecipe>
{
    public const string DiscriminatorValue = "ring_recipe";

    public override RingRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, RingRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static RingRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, RingRecipe value)
    {
