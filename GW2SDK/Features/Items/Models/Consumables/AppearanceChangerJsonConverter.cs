...
internal sealed class AppearanceChangerJsonConverter : JsonConverter<AppearanceChanger>
{
    ...
    public override AppearanceChanger Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, AppearanceChanger value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
