...
public class CurrenciesByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Currency> actual, MessageContext context) = await sut.Hero.Wallet.GetCurrenciesByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
