...
internal sealed class RifleJsonConverter : JsonConverter<Rifle>
{
    public const string DiscriminatorValue = "rifle";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Rifle).IsAssignableFrom(typeToConvert);
    }

    public override Rifle Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Rifle value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Rifle Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Rifle value)
    {
