    ...
    public async Task Can_be_listed()
    {
        ...
        Assert.All(
            ...
            chest => Assert.Contains(
                ...
                new[]
                {
                    "amnytas_heros_choice_chest",
                    "auric_basin_heros_choice_chest",
                    "citadel_of_zakiros_heros_choice_chest",
                    "convergence_heros_choice_chest",
                    ...
                    "gyala_delve_heros_choice_chest",
                    "inner_nayos_heros_choice_chest",
                    "new_kaineng_city_heros_choice_chest",
                    "seitung_province_heros_choice_chest",
                    "skywatch_archipelago_heros_choice_chest",
