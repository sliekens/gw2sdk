...
public class AchievementGroupsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_found()
    {
        ...
        (IImmutableValueSet<AchievementGroup> actual, MessageContext context) = await sut.Hero.Achievements.GetAchievementGroupsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
