...
public class GliderSkinsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<GliderSkin> actual, MessageContext context) = await sut.Hero.Equipment.Gliders.GetGliderSkinsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
