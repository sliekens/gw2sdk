...
internal sealed class RefinementRecipeJsonConverter : JsonConverter<RefinementRecipe>
{
    public const string DiscriminatorValue = "refinement_recipe";

    public override RefinementRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, RefinementRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static RefinementRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, RefinementRecipe value)
    {
