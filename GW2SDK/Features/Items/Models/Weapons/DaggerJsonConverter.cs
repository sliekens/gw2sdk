...
internal sealed class DaggerJsonConverter : JsonConverter<Dagger>
{
    public const string DiscriminatorValue = "dagger";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Dagger).IsAssignableFrom(typeToConvert);
    }

    public override Dagger Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Dagger value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Dagger Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Dagger value)
    {
