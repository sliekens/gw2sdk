...
{
    /// <summary>Starting at this rank level, it takes the number of rank points indicated by <see cref="Points" /> to gain a rank level.</summary>
    public required int MinRank { get; init; }

    /// <summary>Up until this rank level, it takes the number of rank points indicated by <see cref="Points" /> to gain a rank level.</summary>
