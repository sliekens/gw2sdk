...
public class MiniaturesByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<Miniature> actual, MessageContext context) = await sut.Hero.Equipment.Miniatures.GetMiniaturesByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
