...
public class EmblemForegroundsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<EmblemForeground> actual, MessageContext context) = await sut.Guilds.GetEmblemForegroundsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
