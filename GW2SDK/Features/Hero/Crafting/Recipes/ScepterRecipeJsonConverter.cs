...
internal sealed class ScepterRecipeJsonConverter : JsonConverter<ScepterRecipe>
{
    public const string DiscriminatorValue = "scepter_recipe";

    public override ScepterRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, ScepterRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static ScepterRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, ScepterRecipe value)
    {
