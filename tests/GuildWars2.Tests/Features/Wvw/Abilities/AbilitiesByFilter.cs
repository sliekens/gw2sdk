...
public class AbilitiesByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Ability> actual, MessageContext context) = await sut.Wvw.GetAbilitiesByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
