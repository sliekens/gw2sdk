...
internal sealed class ToyJsonConverter : JsonConverter<Toy>
{
    public const string DiscriminatorValue = "toy";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Toy).IsAssignableFrom(typeToConvert);
    }

    public override Toy Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Toy value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Toy Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Toy value)
    {
