...
namespace GW2SDK.Tests.Features.Items
{
    ...
    public class UpgradeComponentDiscriminatorOptionsTest
    {
        public UpgradeComponentDiscriminatorOptionsTest(ItemFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        {
            var sut = new UpgradeComponentDiscriminatorOptions();

            var expected = _fixture.Db.GetUpgradeComponentTypeNames().ToHashSet();
