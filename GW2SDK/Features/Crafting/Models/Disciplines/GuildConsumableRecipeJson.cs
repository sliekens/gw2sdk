...
[PublicAPI]
public static class GuildConsumableRecipeJson
{
    ...
    )
    {
        ...
        OptionalMember guildIngredients = new("guild_ingredients");
        RequiredMember outputUpgradeId = new("output_upgrade_id");
