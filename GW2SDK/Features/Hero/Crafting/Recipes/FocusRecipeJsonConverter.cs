...
internal sealed class FocusRecipeJsonConverter : JsonConverter<FocusRecipe>
{
    public const string DiscriminatorValue = "focus_recipe";

    public override FocusRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, FocusRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static FocusRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, FocusRecipe value)
    {
