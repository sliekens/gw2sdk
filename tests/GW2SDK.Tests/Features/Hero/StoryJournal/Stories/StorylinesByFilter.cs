...
public class StorylinesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Storyline> actual, MessageContext context) = await sut.Hero.StoryJournal.GetStorylinesByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
