...
internal sealed class DaggerSkinJsonConverter : JsonConverter<DaggerSkin>
{
    public const string DiscriminatorValue = "dagger_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(DaggerSkin).IsAssignableFrom(typeToConvert);
    }

    public override DaggerSkin Read(
    ...
    public static DaggerSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, DaggerSkin value)
    {
