...
internal sealed class InscriptionRecipeJsonConverter : JsonConverter<InscriptionRecipe>
{
    public const string DiscriminatorValue = "inscription_recipe";

    public override InscriptionRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, InscriptionRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static InscriptionRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, InscriptionRecipe value)
    {
