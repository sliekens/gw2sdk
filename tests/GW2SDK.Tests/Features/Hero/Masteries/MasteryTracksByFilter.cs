...
public class MasteryTracksByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<MasteryTrack> actual, MessageContext context) = await sut.Hero.Masteries.GetMasteryTracksByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
