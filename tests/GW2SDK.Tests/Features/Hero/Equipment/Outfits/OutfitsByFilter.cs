...
public class OutfitsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Outfit> actual, MessageContext context) = await sut.Hero.Equipment.Outfits.GetOutfitsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
