...
public class DailyRecipes
{
    ...
    public async Task Can_be_found()
    {
        ...
        (HashSet<string> dailyRecipes, _) = await sut.Hero.Crafting.Daily.GetDailyCraftableItems(TestContext.Current!.CancellationToken);
        ...
        (HashSet<string> actual, _) = await sut.Hero.Crafting.Daily.GetDailyCraftedItems(accessToken.Key, TestContext.Current!.CancellationToken);
