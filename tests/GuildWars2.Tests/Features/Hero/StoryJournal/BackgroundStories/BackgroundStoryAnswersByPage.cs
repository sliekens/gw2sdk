...
public class BackgroundStoryAnswersByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<BackgroundStoryAnswer> actual, MessageContext context) = await sut.Hero.StoryJournal.GetBackgroundStoryAnswersByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
        ...
        foreach (BackgroundStoryAnswer entry in actual)
        {
