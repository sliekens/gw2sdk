...
namespace GW2SDK.Tests.Features.Items
{
    ...
    public class ContainerDiscriminatorOptionsTest
    {
        public ContainerDiscriminatorOptionsTest(ItemFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        {
            var sut = new ContainerDiscriminatorOptions();

            var expected = _fixture.Db.GetContainerTypeNames().ToHashSet();
