...
namespace GW2SDK.Tests.Features.Items
{
    ...
    public class UnlockerDiscriminatorOptionsTest
    {
        public UnlockerDiscriminatorOptionsTest(ItemFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        {
            var sut = new UnlockerDiscriminatorOptions();

            var expected = _fixture.Db.GetUnlockerTypeNames().ToHashSet();
