...
internal sealed class MaceSkinJsonConverter : JsonConverter<MaceSkin>
{
    public const string DiscriminatorValue = "mace_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(MaceSkin).IsAssignableFrom(typeToConvert);
    }

    public override MaceSkin Read(
    ...
    public override void Write(Utf8JsonWriter writer, MaceSkin value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static MaceSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, MaceSkin value)
    {
