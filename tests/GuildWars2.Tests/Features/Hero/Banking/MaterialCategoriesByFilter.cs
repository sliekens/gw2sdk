...
public class MaterialCategoriesByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<MaterialCategory> actual, MessageContext context) = await sut.Hero.Bank.GetMaterialCategoriesByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
