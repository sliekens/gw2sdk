...
public sealed class ColorsByPageRequest : IHttpRequest<IReplicaPage<Dye>>
{
    ...
    public async Task<IReplicaPage<Dye>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<Dye>(response.Headers.Date.GetValueOrDefault(),
            value,
