...
public class OutfitsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Outfit> actual, MessageContext context) = await sut.Hero.Equipment.Outfits.GetOutfitsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
