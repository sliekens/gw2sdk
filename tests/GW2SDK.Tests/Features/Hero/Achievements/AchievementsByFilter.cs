...
public class AchievementsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Achievement> actual, MessageContext context) = await sut.Hero.Achievements.GetAchievementsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
