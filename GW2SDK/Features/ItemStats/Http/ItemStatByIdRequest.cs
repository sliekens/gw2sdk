...
public sealed class ItemStatByIdRequest : IHttpRequest<IReplica<ItemStat>>
{
    ...
    public async Task<IReplica<ItemStat>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<ItemStat>(response.Headers.Date.GetValueOrDefault(),
            value,
