...
internal sealed class PistolJsonConverter : JsonConverter<Pistol>
{
    public const string DiscriminatorValue = "pistol";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Pistol).IsAssignableFrom(typeToConvert);
    }

    public override Pistol Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Pistol value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Pistol Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Pistol value)
    {
