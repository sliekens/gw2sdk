...
public sealed class TraitsByPageRequest : IHttpRequest<IReplicaPage<Trait>>
{
    ...
    public async Task<IReplicaPage<Trait>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new ReplicaPage<Trait>(response.Headers.Date.GetValueOrDefault(),
            value,
