...
{
    public const string DiscriminatorValue = "currency";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Currency).IsAssignableFrom(typeToConvert);
    }
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, Currency value)
    {
