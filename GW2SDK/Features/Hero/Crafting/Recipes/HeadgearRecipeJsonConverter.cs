...
internal sealed class HeadgearRecipeJsonConverter : JsonConverter<HeadgearRecipe>
{
    public const string DiscriminatorValue = "headgear_recipe";

    public override HeadgearRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, HeadgearRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static HeadgearRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, HeadgearRecipe value)
    {
