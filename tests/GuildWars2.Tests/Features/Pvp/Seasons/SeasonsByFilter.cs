...
public class SeasonsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Season> actual, MessageContext context) = await sut.Pvp.GetSeasonsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
