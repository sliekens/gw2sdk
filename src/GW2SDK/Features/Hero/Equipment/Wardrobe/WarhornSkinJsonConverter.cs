...
internal sealed class WarhornSkinJsonConverter : JsonConverter<WarhornSkin>
{
    public const string DiscriminatorValue = "warhorn_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(WarhornSkin).IsAssignableFrom(typeToConvert);
    }

    public override WarhornSkin Read(
    ...
    public static WarhornSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, WarhornSkin value)
    {
