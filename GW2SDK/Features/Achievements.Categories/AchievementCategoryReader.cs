...
namespace GW2SDK.Achievements.Categories
{
    ...
    public sealed class AchievementCategoryReader : IJsonReader<AchievementCategory>
    {
        ...
        private AchievementRef ReadAchievementRef(JsonElement json, MissingMemberBehavior missingMemberBehavior)
        {
            var id = new RequiredMember<int>("id");
        ...
        private LevelRequirement ReadLevel(JsonElement json, MissingMemberBehavior missingMemberBehavior)
        {
            var min = json[0]
                .GetInt32();
            var max = json[1]
