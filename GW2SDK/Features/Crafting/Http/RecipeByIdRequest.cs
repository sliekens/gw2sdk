...
public sealed class RecipeByIdRequest : IHttpRequest<IReplica<Recipe>>
{
    ...
    public async Task<IReplica<Recipe>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<Recipe>(response.Headers.Date.GetValueOrDefault(),
            value,
