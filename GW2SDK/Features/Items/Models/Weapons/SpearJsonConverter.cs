...
internal sealed class SpearJsonConverter : JsonConverter<Spear>
{
    public const string DiscriminatorValue = "spear";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Spear).IsAssignableFrom(typeToConvert);
    }

    public override Spear Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Spear value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Spear Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Spear value)
    {
