...
public class MaterialCategoriesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<MaterialCategory> actual, MessageContext context) = await sut.Hero.Bank.GetMaterialCategoriesByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
