...
public class HeartsIndex(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<int> actual, MessageContext context) = await sut.Exploration.GetHeartsIndex(continentId, floorId, regionId, mapId, TestContext.Current!.Execution.CancellationToken);
