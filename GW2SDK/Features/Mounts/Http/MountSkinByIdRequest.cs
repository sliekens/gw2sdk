...
public sealed class MountSkinByIdRequest : IHttpRequest<IReplica<MountSkin>>
{
    ...
    public async Task<IReplica<MountSkin>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<MountSkin>(response.Headers.Date.GetValueOrDefault(),
            value,
