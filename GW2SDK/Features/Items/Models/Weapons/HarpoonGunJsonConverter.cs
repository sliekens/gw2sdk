...
internal sealed class HarpoonGunJsonConverter : JsonConverter<HarpoonGun>
{
    public const string DiscriminatorValue = "harpoon_gun";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(HarpoonGun).IsAssignableFrom(typeToConvert);
    }

    public override HarpoonGun Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, HarpoonGun value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
    ...
    public static void Write(Utf8JsonWriter writer, HarpoonGun value)
    {
