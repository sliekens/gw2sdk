...
internal sealed class ToyTwoHandedSkinJsonConverter : JsonConverter<ToyTwoHandedSkin>
{
    public const string DiscriminatorValue = "toy_two_handed_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(ToyTwoHandedSkin).IsAssignableFrom(typeToConvert);
    }

    public override ToyTwoHandedSkin Read(
    ...
    public static ToyTwoHandedSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, ToyTwoHandedSkin value)
    {
