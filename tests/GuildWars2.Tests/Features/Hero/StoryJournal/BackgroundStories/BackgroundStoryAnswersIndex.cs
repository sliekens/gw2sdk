...
public class BackgroundStoryAnswersIndex(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<string> actual, MessageContext context) = await sut.Hero.StoryJournal.GetBackgroundStoryAnswersIndex(TestContext.Current!.Execution.CancellationToken);
