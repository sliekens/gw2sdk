...
namespace GW2SDK.Tests.Features.Items
{
    ...
    public class ToolDiscriminatorOptionsTest
    {
        public ToolDiscriminatorOptionsTest(ItemFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        {
            var sut = new ToolDiscriminatorOptions();

            var expected = _fixture.Db.GetToolTypeNames().ToHashSet();
