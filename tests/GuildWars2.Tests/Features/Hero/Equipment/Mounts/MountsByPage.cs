...
public class MountsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_page()
    {
        ...
        (IImmutableValueSet<Mount> actual, MessageContext context) = await sut.Hero.Equipment.Mounts.GetMountsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
