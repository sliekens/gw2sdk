...
public class MiniaturesIndex(Gw2Client sut)
{
    ...
    {
        (IImmutableValueSet<int> actual, MessageContext context) = await sut.Hero.Equipment.Miniatures.GetMiniaturesIndex(TestContext.Current!.Execution.CancellationToken);
