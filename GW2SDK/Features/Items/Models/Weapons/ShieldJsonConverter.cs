...
internal sealed class ShieldJsonConverter : JsonConverter<Shield>
{
    public const string DiscriminatorValue = "shield";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Shield).IsAssignableFrom(typeToConvert);
    }

    public override Shield Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public static Shield Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Shield value)
    {
