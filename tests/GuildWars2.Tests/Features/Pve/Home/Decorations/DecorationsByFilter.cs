...
public class DecorationsByFilter(Gw2Client sut)
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (IImmutableValueSet<Decoration> actual, MessageContext context) = await sut.Pve.Home.GetDecorationsByIds(ids, cancellationToken: TestContext.Current!.Execution.CancellationToken);
