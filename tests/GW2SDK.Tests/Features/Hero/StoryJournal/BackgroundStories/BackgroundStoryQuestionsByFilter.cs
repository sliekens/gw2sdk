...
public class BackgroundStoryQuestionsByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<BackgroundStoryQuestion> actual, MessageContext context) = await sut.Hero.StoryJournal.GetBackgroundStoryQuestionsByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
