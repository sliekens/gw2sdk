...
internal sealed class PistolRecipeJsonConverter : JsonConverter<PistolRecipe>
{
    public const string DiscriminatorValue = "pistol_recipe";

    public override PistolRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, PistolRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static PistolRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, PistolRecipe value)
    {
