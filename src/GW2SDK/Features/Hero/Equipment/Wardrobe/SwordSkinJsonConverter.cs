...
internal sealed class SwordSkinJsonConverter : JsonConverter<SwordSkin>
{
    public const string DiscriminatorValue = "sword_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(SwordSkin).IsAssignableFrom(typeToConvert);
    }

    public override SwordSkin Read(
    ...
    public static SwordSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, SwordSkin value)
    {
