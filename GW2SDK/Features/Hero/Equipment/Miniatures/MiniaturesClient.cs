...
public sealed class MiniaturesClient
{
    ...
    {
        RequestBuilder requestBuilder = RequestBuilder.HttpGet("v2/account/minis", accessToken);
    ...
    {
        RequestBuilder requestBuilder = RequestBuilder.HttpGet("v2/minis");
        ...
        using (response.Json)
        {
            ...
            ValueHashSet<Miniature> value = response.Json.RootElement.GetSet(static (in JsonElement entry) => entry.GetMiniature());
            return (value, response.Context);
        }
    }
    ...
    )
    {
        ...
        {
            JsonOptions.MissingMemberBehavior = missingMemberBehavior;
            Miniature value = response.Json.RootElement.GetMiniature();
            return (value, response.Context);
        }
    }
