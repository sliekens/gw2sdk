...
namespace GW2SDK.Continents
{
    ...
    public sealed class ContinentService
    {
        ...
        )
        {
            ...
            return await http
                .GetResourcesSet(request, json => continentReader.ReadArray(json, missingMemberBehavior), cancellationToken)
        ...
        public async Task<IReplicaSet<int>> GetContinentsIndex(CancellationToken cancellationToken = default)
        {
            ...
            return await http
                .GetResourcesSet(request, json => continentReader.Id.ReadArray(json, missingMemberBehavior), cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        )
        {
            ...
            return await http.GetResource(request, json => continentReader.Read(json, missingMemberBehavior), cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        )
        {
            ...
            return await http
                .GetResourcesPage(request, json => continentReader.ReadArray(json, missingMemberBehavior), cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        )
        {
            ...
            return await http.GetResource(request, json => continentReader.Floor.Read(json, missingMemberBehavior), cancellationToken)
                .ConfigureAwait(false);
        }
