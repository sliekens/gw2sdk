...
internal sealed class SmallBundleSkinJsonConverter : JsonConverter<SmallBundleSkin>
{
    public const string DiscriminatorValue = "small_bundle_skin";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(SmallBundleSkin).IsAssignableFrom(typeToConvert);
    }

    public override SmallBundleSkin Read(
    ...
    public static SmallBundleSkin Read(in JsonElement json)
    {
...
#pragma warning restore CS0618
    ...
    public static void Write(Utf8JsonWriter writer, SmallBundleSkin value)
    {
