...
{
    [PublicAPI]
    public sealed class GemsForGoldReader : IJsonReader<GemsForGoldExchange>
    {
        public GemsForGoldExchange Read(JsonElement json, MissingMemberBehavior missingMemberBehavior)
        {
