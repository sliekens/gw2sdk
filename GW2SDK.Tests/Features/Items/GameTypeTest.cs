...
namespace GW2SDK.Tests.Features.Items
{
    ...
    public class GameTypeTest
    {
        ...
        public void Game_type_can_be_serialized_from_json()
        {
        ...
        [Trait("Feature",  "Items")]
        [Trait("Category", "Unit")]
        public void Game_type_has_no_default_member()
        {
            Assert.False(Enum.IsDefined(typeof(GameType), default(GameType)));
        }
    }
}
