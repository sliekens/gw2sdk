...
public class BackgroundStoryAnswersByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<BackgroundStoryAnswer> actual, MessageContext context) = await sut.Hero.StoryJournal.GetBackgroundStoryAnswersByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
