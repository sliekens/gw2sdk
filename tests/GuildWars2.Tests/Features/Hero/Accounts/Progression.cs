...
public class Progression(Gw2Client sut)
{
    ...
    public async Task Can_be_listed()
    {
        ...
        (IImmutableValueSet<GuildWars2.Hero.Accounts.Progression> actual, _) = await sut.Hero.Account.GetProgression(accessToken.Key, cancellationToken: TestContext.Current!.Execution.CancellationToken).ConfigureAwait(true);
