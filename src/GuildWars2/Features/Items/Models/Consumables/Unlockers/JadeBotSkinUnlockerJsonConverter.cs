...
internal sealed class JadeBotSkinUnlockerJsonConverter : JsonConverter<JadeBotSkinUnlocker>
{
    public const string DiscriminatorValue = "jade_bot_skin_unlocker";
    ...
    public static JadeBotSkinUnlocker Read(in JsonElement json)
    {
