...
public class LegendaryItemsByPage(Gw2Client sut)
{
    ...
    public async Task Can_be_listed()
    {
        ...
        (IImmutableValueSet<LegendaryItem> actual, MessageContext context) = await sut.Hero.Equipment.Templates.GetLegendaryItemsByPage(0, pageSize, cancellationToken: TestContext.Current!.Execution.CancellationToken);
