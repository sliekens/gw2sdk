...
internal static class ToyTwoHandedJson
{
    public static ToyTwoHanded GetToyTwoHanded(this in JsonElement json)
    {
        ...
        return new ToyTwoHanded
        {
            ...
            MaxPower = maxPower.Map(static (in value) => value.GetInt32()),
