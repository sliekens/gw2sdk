...
public class AchievementGroups
{
    ...
    public async Task Can_be_listed()
    {
        ...
        (HashSet<AchievementGroup> actual, MessageContext context) = await sut.Hero.Achievements.GetAchievementGroups(cancellationToken: TestContext.Current!.CancellationToken);
