...
internal sealed class BootsRecipeJsonConverter : JsonConverter<BootsRecipe>
{
    public const string DiscriminatorValue = "boots_recipe";

    public override BootsRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, BootsRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static BootsRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, BootsRecipe value)
    {
