...
public sealed class MasteryByIdRequest : IHttpRequest<IReplica<Mastery>>
{
    ...
    public async Task<IReplica<Mastery>> SendAsync(HttpClient httpClient, CancellationToken cancellationToken)
    {
        ...
        return new Replica<Mastery>(response.Headers.Date.GetValueOrDefault(),
            value,
