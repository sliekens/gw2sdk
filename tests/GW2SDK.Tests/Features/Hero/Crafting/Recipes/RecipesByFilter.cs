...
public class RecipesByFilter
{
    ...
    public async Task Can_be_filtered_by_id()
    {
        ...
        (HashSet<Recipe> actual, MessageContext context) = await sut.Hero.Crafting.Recipes.GetRecipesByIds(ids, cancellationToken: TestContext.Current!.CancellationToken);
