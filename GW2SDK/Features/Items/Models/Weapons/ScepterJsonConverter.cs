...
internal sealed class ScepterJsonConverter : JsonConverter<Scepter>
{
    public const string DiscriminatorValue = "scepter";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Scepter).IsAssignableFrom(typeToConvert);
    }

    public override Scepter Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Scepter value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Scepter Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Scepter value)
    {
