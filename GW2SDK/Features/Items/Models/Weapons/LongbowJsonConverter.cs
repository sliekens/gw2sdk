...
internal sealed class LongbowJsonConverter : JsonConverter<Longbow>
{
    public const string DiscriminatorValue = "longbow";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(Longbow).IsAssignableFrom(typeToConvert);
    }

    public override Longbow Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, Longbow value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static Longbow Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, Longbow value)
    {
