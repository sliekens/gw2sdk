...
internal sealed class StaffRecipeJsonConverter : JsonConverter<StaffRecipe>
{
    public const string DiscriminatorValue = "staff_recipe";

    public override StaffRecipe Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, StaffRecipe value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }

    public static StaffRecipe Read(JsonElement json)
    {
    ...
    public static void Write(Utf8JsonWriter writer, StaffRecipe value)
    {
