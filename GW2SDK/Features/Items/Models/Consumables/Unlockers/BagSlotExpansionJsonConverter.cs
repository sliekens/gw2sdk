...
internal sealed class BagSlotExpansionJsonConverter : JsonConverter<BagSlotExpansion>
{
    public const string DiscriminatorValue = "bag_slot_expansion";

    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(BagSlotExpansion).IsAssignableFrom(typeToConvert);
    }

    public override BagSlotExpansion Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        using var json = JsonDocument.ParseValue(ref reader);
        return Read(json.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, BagSlotExpansion value, JsonSerializerOptions options)
    {
        Write(writer, value);
    }
    ...
    public static void Write(Utf8JsonWriter writer, BagSlotExpansion value)
    {
